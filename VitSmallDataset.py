...
class Transformer(nn.Module):
    def __init__(self, dim, depth, heads, dim_head, mlp_dim, dropout = 0.):
        super().__init__()
        # nn.ModuleList()类似nn.Sequential()，但是前者需要自己写forward函数，后者可以不写。
...
if __name__ == '__main__':
    测试模型 = ViT(depth=12, dim=768, heads=8, image_size=224, mlp_dim=768, num_classes=5, patch_size=16)
